...
load("/Users/expeditoolimi/Documents/Southampton/Global_tomato_seed_Microbiome/Tomato100_Project/Tomato-seed-microbiome/ps0.RData")
...
save(ps, file = "/Users/expeditoolimi/Documents/Southampton/Global_tomato_seed_Microbiome/Tomato100_Project/Tomato-seed-microbiome/ps.RData")
...
```{r,echo = FALSE,warning = FALSE}
load("/Users/expeditoolimi/Documents/Southampton/Global_tomato_seed_Microbiome/Tomato100_Project/Tomato-seed-microbiome/Tomato-seed-microbiome/ps.RData")
...
# save 
```{r}
save(ps2, file = "/Users/expeditoolimi/Documents/Southampton/Global_tomato_seed_Microbiome/Tomato100_Project/Tomato-seed-microbiome/ps2.RData")
```
...
#corr1=ggplot(data = data.frame("total_reads" =  phyloseq::sample_sums(ps2),
    #                           "observed" = phyloseq::estimate_richness(ps2, measures = "Observed")[, 1]),
...
#Order level
psmelt(ps.toptax)
gg4=ggplot(psmelt(ps.toptax), aes(x=reorder(Sample, English_Name), y=Abundance, fill=Order))+
  geom_bar(stat = "identity", position = "stack", width = 1) +
  #scale_fill_manual(values=c(ocean.dense(7), ocean.tempo(8)))+
  #scale_fill_manual(values=c("#25725d", "#439b5b", "#7bc369", "#abd69a", "#d8e8b0", "#cccda7", "#bfb77b", "#7e9998", "#92B2B2", "#83bbbf", "#61acc1", "#58a0c4", "#7087c3","#8973b4", "#512972"))+
  scale_fill_manual(values = mycola)+
  ...
  theme(legend.text = element_text(face = c(rep("italic", 5), rep("plain", 5))))+
  guides(fill= guide_legend(keywidth = 0.6, keyheight = 0.6, nrow = 2))+
  theme(text=element_text(size=8,  family="Arial"))+ labs(tag = "");gg4

library(ggpubr)
tiff("gg4_Region_cultivar.tiff", units="in", width=10, height=6, res=300)
gg4_Region_cultivar.tiff=gg4+plot_layout(nrow = 1);gg4_Region_cultivar.tiff
ggsave("gg4_Region_cultivar.tiff", plot = gg4_Region_cultivar.tiff)
dev.off()

#Insect_resistance as a factor
Insect_resistance_ps_toptax <- subset_samples(ps.toptax, !is.na(Insect_resistance));Insect_resistance_ps_toptax
gg3=ggplot(psmelt(Insect_resistance_ps_toptax), aes(x=reorder(Sample, English_Name), y=Abundance, fill=Family))+
  geom_bar(stat = "identity", position = "stack", width = 1) +
  #scale_fill_manual(values=c(ocean.dense(7), ocean.tempo(8)))+
  #scale_fill_manual(values=c("#25725d", "#439b5b", "#7bc369", "#abd69a", "#d8e8b0", "#cccda7", "#bfb77b", "#7e9998", "#92B2B2", "#83bbbf", "#61acc1", "#58a0c4", "#7087c3","#8973b4", "#512972"))+
  scale_fill_manual(values = mycola)+
  xlab("") + ylab("Relative abundance (%)") +
  facet_wrap(~reorder(Insect_resistance, Sample), scales = "free_x", nrow = 1) + 
  ggtitle("Class, top 500 ASVs") +
  theme_pubclean() + theme(legend.position="bottom", axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=0)) +
  theme(legend.text = element_text(face = c(rep("italic", 5), rep("plain", 5))))+
  guides(fill= guide_legend(keywidth = 0.6, keyheight = 0.6, nrow = 8))+
  theme(text=element_text(size=8,  family="Arial"))+ labs(tag = "A");gg3

library(ggpubr)
tiff("gg3_cultivar.tiff", units="in", width=14, height=8, res=300)
gg3_cultivar.tiff=gg3+plot_layout(nrow = 1);gg3_cultivar.tiff
ggsave("gg3_cultivar.tiff", plot = gg3_cultivar.tiff)
dev.off()
...
```{r,echo=FALSE,warning=FALSE,message=FALSE}
 load("/Users/expeditoolimi/Documents/Southampton/Global_tomato_seed_Microbiome/Tomato100_Project/Tomato-seed-microbiome/ps.RData")
...
#& the the TSS (proportion; relative abundance)
...
#The conference trainings on data analysis
...
save(ps_hellinger, file = "/Users/expeditoolimi/Documents/Southampton/Global_tomato_seed_Microbiome/Tomato100_Project/Tomato-seed-microbiome/ps_hellinger.RData")

#Load the hellinger transformed data
load ("/Users/expeditoolimi/Documents/Southampton/Global_tomato_seed_Microbiome/Tomato100_Project/Tomato-seed-microbiome/ps_hellinger.RData")
...
# Ensure the x-axis (Group) is ordered in ascending order
data_fram_cultivar$Group <- factor(data_fram_cultivar$Group,
                                   levels = sort(unique(data_fram_cultivar$Group)))

dispr_cultivar = ggboxplot(
  data_fram_cultivar,
  x = "Group",
  y = "Distance_to_centroid",
  fill = "Group",
  ylab = "Distance to centroid",
  xlab = "Cultivars (n=100)"
) +
  ...
  theme(
    axis.title.x = element_text(face = "bold", colour = "gray33", size = 12),
    axis.title.y = element_text(face = "bold", colour = "gray33", size = 12),
    axis.text.x = element_text(face = "bold", colour = "gray33", size = 12),
    axis.text.y = element_text(colour = "gray33", size = 12)
  ) +
...
vegan::adonis2(hellinger_dist_matrix ~ phyloseq::sample_data(ps_hellinger)$Production_site_2, permutation=999)
#                                                      Df SumOfSqs      R2      F Pr(>F)    
#phyloseq::sample_data(ps_hellinger)$Production_site_2   11   35.537 0.11415 13.882  0.001 ***
...
#ADONIS test
vegan::adonis2(hellinger_dist_matrix_TMV ~ phyloseq::sample_data(ps_hellinger_TMV_resistance)$TMV_resistance, permutation=999)
 #                                                                  Df SumOfSqs      R2      F Pr(>F)    
#phyloseq::sample_data(ps_hellinger_TMV_resistance)$TMV_resistance   2    2.309 0.01489 4.6794  0.001 ***
#Residual                                                          619  152.751 0.98511                  
#Total                                                             621  155.061 1.00000
...
#ADONIS test
vegan::adonis2(hellinger_dist_matrix_Insect_resistance ~ phyloseq::sample_data(ps_hellinger_Insect_resistance)$Insect_resistance, permutation=999)

#                                                                        Df SumOfSqs      R2      F Pr(>F)    
#phyloseq::sample_data(ps_hellinger_Insect_resistance)$Insect_resistance   5   10.811 0.07079 9.0201  0.001 ***
...
#ADONIS test
vegan::adonis2(hellinger_dist_matrix_Fruit_shape ~ phyloseq::sample_data(ps_hellinger_Fruit_shape)$Fruit_shape, permutation=999)
#                                                               Df SumOfSqs      R2      F Pr(>F)    
#phyloseq::sample_data(ps_hellinger_Fruit_shape)$Fruit_shape    2     4.41 0.01431 8.5779  0.001 ***
#Residual                                                    1182   303.82 0.98569                  
#Total                                                       1184   308.23 1.00000  
...
#ADONIS test
vegan::adonis2(hellinger_dist_matrix_Fruit_color ~ phyloseq::sample_data(ps_hellinger_Fruit_color)$Fruit_color, permutation=999)
#                                                              Df SumOfSqs      R2      F Pr(>F)    
#phyloseq::sample_data(ps_hellinger_Fruit_color)$Fruit_color    4    7.877 0.02555 7.7362  0.001 ***
#Residual                                                    1180  300.354 0.97445                  
#Total                                                       1184  308.231 1.00000
...
#ADONIS test
vegan::adonis2(hellinger_dist_matrix_yield ~ phyloseq::sample_data(ps_hellinger_yield)$yield, permutation=999)
#                                                  Df SumOfSqs      R2      F Pr(>F)    
#phyloseq::sample_data(ps_hellinger_yield)$yield    4    8.256 0.03093 8.2746  0.001 ***
...
#ADONIS test
vegan::adonis2(hellinger_dist_matrix_ovaries ~ phyloseq::sample_data(ps_hellinger_ovaries)$ovaries, permutation=999)
#                                                      Df SumOfSqs     R2      F Pr(>F)    
#phyloseq::sample_data(ps_hellinger_ovaries)$ovaries    2    5.122 0.0179 10.104  0.001 ***
#Residual                                            1109  281.122 0.9821                  
#Total                                               1111  286.245 1.0000
...
#ADONIS test
vegan::adonis2(hellinger_dist_matrix_seedweight_1000 ~ phyloseq::sample_data(ps_hellinger_seedweight_1000)$seedweight_1000, permutation=999)
#                                                                     Df SumOfSqs      R2      F Pr(>F)    
#phyloseq::sample_data(ps_hellinger_seedweight_1000)$seedweight_1000   3    6.822 0.03147 9.1536  0.001 ***
...
#ADONIS test
vegan::adonis2(hellinger_dist_matrix_Fruit_hori_diameter ~ phyloseq::sample_data(ps_hellinger_Fruit_hori_diameter)$Fruit_hori_diameter, permutation=999)
#                                                                             Df SumOfSqs      R2      F Pr(>F)    
#phyloseq::sample_data(ps_hellinger_Fruit_hori_diameter)$Fruit_hori_diameter    2    5.201 0.01846 10.257  0.001 ***
#Residual                                                                    1091  276.606 0.98154                  
#Total                                                                       1093  281.807 1.00000 
...
#ADONIS test
vegan::adonis2(hellinger_dist_matrix_Fruit_long_diameter ~ phyloseq::sample_data(ps_hellinger_Fruit_long_diameter)$Fruit_long_diameter, permutation=999)
#                                                                              Df SumOfSqs      R2      F Pr(>F)    
#phyloseq::sample_data(ps_hellinger_Fruit_long_diameter)$Fruit_long_diameter    2    5.583 0.02014 11.086  0.001 ***
...
library(MicrobiotaProcess)
ps2= subset_samples(ps2, Production_site_2 %in% c("Jiangsu"));ps2#[ 15421 taxa & 1102 samples ]
distme_ps2 <- get_dist(ps2, distmethod ="bray", method="hellinger");distme_ps2
sampleda_ps2 <- data.frame(sample_data(ps2), check.names=FALSE);sampleda_ps2
sampleda_ps2 <- sampleda_ps2[match(colnames(as.matrix(distme_ps2)),rownames(sampleda_ps2)),,drop=FALSE];sampleda_ps2
sampleda_ps2$English_Name_2 <- factor(sampleda_ps2$English_Name_2)
adores <- adonis2(distme_ps2 ~ English_Name_2, data=sampleda_ps2, permutation=999);adores#change from adonis to adonis2
#         Df SumOfSqs      R2      F Pr(>F)    
...
#Figure
pcoares_ps2 <- get_pcoa(obj=ps2, distmethod="bray", method="hellinger");pcoares_ps2#pcoa
pcoaplot_ps2 <- ggordpoint(obj=pcoares_ps2, biplot=F, speciesannot=F,
                              factorNames=c("English_Name_2"), ellipse=F) +
  scale_fill_manual(values=mycola)+
  ...
  theme(legend.title=element_blank())+
  theme(text=element_text(size=12,  family="sans"))+ labs(tag = "");pcoaplot_ps2

tiff("pcoaplot_ps2.tiff", units="in", width=8, height=5, res=300)
pcoaplot_ps2.tiff=(pcoaplot_ps2);pcoaplot_ps2.tiff
ggsave("pcoaplot_ps2.tiff", plot = pcoaplot_ps2.tiff)
dev.off()
...
#consider the region of production
```{r,echo=FALSE, warning=FALSE}
load("/Users/expeditoolimi/Documents/Southampton/Global_tomato_seed_Microbiome/Tomato100_Project/Tomato-seed-microbiome/ps2.RData")
library(MicrobiotaProcess)
pcares <- get_pca(obj=ps2, method="hellinger");pcares# for PCA ordination to show sample distribution
...
suppressWarnings (try(write.table(norm_otu_table,"/Users/expeditoolimi/Documents/Southampton/Global_tomato_seed_Microbiome/Tomato100_Project/Tomato-seed-microbiome/Rhea_package/1.Normalization_2.Alpha-Diversity/OTUs_Table-norm.tab", sep = "\t",col.names = NA, quote = FALSE), silent =TRUE))
...
#' Note: the path is denoted by forward slash "/"
setwd("/Users/expeditoolimi/Documents/Southampton/Global_tomato_seed_Microbiome/Tomato100_Project/Tomato-seed-microbiome/Rhea/2.Alpha-Diversity/Diversity_500_rarefaction")    #<--- CHANGE ACCORDINGLY
...
otu_table <- read.table ("/Users/expeditoolimi/Documents/Southampton/Global_tomato_seed_Microbiome/Tomato100_Project/Tomato-seed-microbiome/Rhea_package/1.Normalization_2.Alpha-Diversity/OTUs_Table-norm.tab", 
                       check.names = FALSE, 
                       header=TRUE, 
                       dec=".", 
                       sep = "\t",
...
set/Users/expeditoolimi/Documents/Southampton/Global_tomato_seed_Microbiome/Tomato100_Project/Tomato-seed-microbiome("/Users/expeditoolimi/Documents/Southampton/Global_tomato_seed_Microbiome/Tomato100_Project/Tomato-seed-microbiome/Rhea_package/1.Normalization_2.Alpha-Diversity")
...
ggsave(
  "/Users/expeditoolimi/Documents/Southampton/Global_tomato_seed_Microbiome/Tomato100_Project/Tomato-seed-microbiome/PA.tiff",
  plot = PA,
  scale = 1,
  width = 18,
  height = 9,
...
tiff("pd_Simpson_eveness_Effective_alpha_diversity.tiff", units="in", width=19, height=12, res=300)
...
#t1 <- trans_env$new(datasetwd(" = mt, add_data = env_data[, 1:12]);t1 
#t1$data_env
...
# it is better to clone a datasetwd("
tmp_mt <- clone(mt)
...
t2 <- trans_diff$new(datasetwd(" = tmp_mt, method = "anova", group = "Insect_resistance", taxa_level = "func")
...
setwd("wd("/Users/expeditoolimi/Documents/Southampton/Global_tomato_seed_Microbiome/Tomato100_Project/Tomato-seed-microbiome/")
...
padj.cutoff <- 0.05
lfc.cutoff <- 0.58
#The lfc.cutoff is setwd(" to 0.58; remember that we are working with log2 fold changes so this translates to an actual fold #change of 1.5 which is pretty reasonable. Let’s create vector that helps us identify the genes that meet our criteria:
